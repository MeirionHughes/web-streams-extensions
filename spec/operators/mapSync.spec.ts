...
import { from, pipe, mapSync, toArray, throwError, toPromise, Subject } from "../../src/index.js";
...
describe("mapSync", () => {
  describe("Real Time", () => {
    ...
    it("should filter out undefined values", async () => {
      ...
      const result = await toArray(pipe(
        from(input),
        mapSync((x: number) => x % 2 === 0 ? x : undefined)
      ));
    ...
    it("should work with complex transformations", async () => {
      ...
      const result = await toArray(pipe(
        from(input),
        mapSync((person: any) => person.age >= 30 ? `${person.name} (adult)` : undefined)
      ));
    ...
    it("should handle null and undefined inputs", async () => {
      ...
      const result = await toArray(pipe(
        from(input),
        mapSync((x: any) => x != null ? x * 2 : undefined)
      ));
    ...
    it("should handle zero values", async () => {
      ...
      const result = await toArray(pipe(
        from(input),
        mapSync((x: number) => x === 0 ? 'zero' : x.toString())
      ));
    ...
    it("should handle stream errors from subjects", async () => {
      const subject = new Subject<number>();
    ...
    it("should handle large arrays", async () => {
      ...
      expect(result[99]).to.equal(198);
    });

    it("should preserve order with complex data", async () => {
      const input = ['apple', 'banana', 'cherry', 'date'];
      
      const result = await toArray(pipe(
        from(input),
        mapSync((x: string) => x.length > 5 ? x.toUpperCase() : undefined)
      ));
      
      expect(result).to.deep.equal(['BANANA', 'CHERRY']);
    });

    it("should handle mixed data types", async () => {
      const input = [1, 'hello', true, null, { id: 42 }];
      
      const result = await toArray(pipe(
        from(input),
        mapSync((x: any) => typeof x)
      ));
      
      expect(result).to.deep.equal(['number', 'string', 'boolean', 'object', 'object']);
    });
    ...
    it("should handle array inputs", async () => {
      ...
      const result = await toArray(pipe(
        from(input),
        mapSync((arr: number[]) => arr.reduce((sum, val) => sum + val, 0))
      ));
    ...
    it("should handle conditional transformations", async () => {
      ...
      const result = await toArray(pipe(
        from(input),
        mapSync((x: number) => {
          if (x % 3 === 0) return 'divisible by 3';
          if (x % 2 === 0) return 'even';
          return 'odd';
        })
      ));
      
      expect(result).to.deep.equal(['odd', 'even', 'divisible by 3', 'even', 'odd', 'divisible by 3']);
    });

    it("should handle date transformations", async () => {
      const input = [new Date('2023-01-01'), new Date('2023-12-31')];
      
      const result = await toArray(pipe(
        from(input),
        mapSync((date: Date) => date.getFullYear())
      ));
    ...
    it("should handle regex transformations", async () => {
      ...
      const result = await toArray(pipe(
        from(input),
        mapSync((str: string) => str.replace(/\d+/g, ''))
      ));
  ...
  describe("Virtual Time", () => {
    describe("Basic Behavior", () => {
      it("should map values one-to-one synchronously", async () => {
        const scheduler = new VirtualTimeScheduler();
        await scheduler.run(async ({ cold, expectStream }) => {
          const stream = cold('abcd|', { a: 1, b: 2, c: 3, d: 4 });
          const result = pipe(stream, mapSync((x: number) => x * 2));
      ...
      it("should handle single element", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => x * 3));
      ...
      it("should map to different types", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => x.toString()));
      ...
      it("should filter out undefined values", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          const stream = cold('abc|', { a: 1, b: 2, c: 3 });
          const result = pipe(stream, mapSync((x: number) => x === 2 ? undefined : x * 2));
      ...
      it("should preserve timing", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => x * 10));
    ...
    describe("Timing Patterns", () => {
      ...
      it("should handle spaced emissions", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          const stream = cold('a-----b-----c|', { a: 1, b: 2, c: 3 });
          const result = pipe(stream, mapSync((x: number) => x * x));
      ...
      it("should handle mixed timing patterns", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => x + 100));
    ...
    describe("Error Handling", () => {
      ...
      it("should handle mapping function errors", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => {
            throw new Error('mapSync error');
          }));
          expectStream(result).toBe('#', undefined, new Error('mapSync error'));
        });
      });
    ...
    describe("Data Types", () => {
      it("should handle string transformations", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: string) => x.toUpperCase()));
      ...
      it("should handle object transformations", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: any) => x.name));
      ...
      it("should handle array transformations", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number[]) => x.length));
      ...
      it("should handle boolean transformations", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: boolean) => !x));
          expectStream(result).toBe('abcd|', { a: false, b: true, c: false, d: true });
        });
      });

      it("should handle simple null and undefined values", async () => {
        const scheduler = new VirtualTimeScheduler();
        await scheduler.run(async ({ cold, expectStream }) => {
          const stream = cold('abc|', { a: 1, b: 2, c: 3 });
          const result = pipe(stream, mapSync((x: number) => x * 2));
      ...
      it("should handle mixed data types", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: any) => typeof x));
    ...
    describe("Complex Transformations", () => {
      it("should handle complex mathematical operations", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          const stream = cold('abcd|', { a: 1, b: 2, c: 3, d: 4 });
          const result = pipe(stream, mapSync((x: number) => Math.pow(x, 2) + x));
      ...
      it("should handle string processing", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          const stream = cold('abc|', { a: 'hello', b: 'world', c: 'test' });
          const result = pipe(stream, mapSync((x: string) => x.split('').reverse().join('')));
      ...
      it("should handle nested object access", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: any) => x.user.name));
          expectStream(result).toBe('ab|', { a: 'Alice', b: 'Bob' });
        });
      });
      ...
      it("should handle array operations", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number[]) => x.reduce((sum, val) => sum + val, 0)));
      ...
      it("should handle conditional mapping", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => x % 2 === 0 ? x * 2 : x + 10));
    ...
    describe("Edge Cases", () => {
      ...
      it("should handle false values correctly", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: boolean) => x ? 'yes' : 'no'));
      ...
      it("should handle empty string values", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: string) => x.length));
      ...
      it("should handle large numbers", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => x + 1));
      ...
      it("should handle NaN values", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => isNaN(x) ? 0 : x * 2));
      ...
      it("should handle Infinity values", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          ...
          const result = pipe(stream, mapSync((x: number) => isFinite(x) ? x * 2 : 'infinite'));
      ...
      it("should handle filtered results", async () => {
        ...
        await scheduler.run(async ({ cold, expectStream }) => {
          const stream = cold('abcdef|', { a: 1, b: 2, c: 3, d: 4, e: 5, f: 6 });
          const result = pipe(stream, mapSync((x: number) => x % 2 === 0 ? x : undefined));
          expectStream(result).toBe('-b-d-f|', { b: 2, d: 4, f: 6 });
        });
      });
    });
  });
